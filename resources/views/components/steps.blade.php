{{--https://flowbite.com/docs/components/stepper/#timeline-stepper--}}

<ol class="relative text-gray-500 border-l border-gray-200 dark:border-gray-700 dark:text-gray-400 ml-4">
    <li class="mb-10 ml-6">
